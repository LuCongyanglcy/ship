...
public class HistoryTimeAdapter extends BaseAdapter{
	...
	public HistoryTimeAdapter(Context context, String[][] cities,int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.historylist_time, null);
			viewHolder = new ViewHolder();
			viewHolder.textView = (TextView) convertView
					.findViewById(R.id.hstextview1);
